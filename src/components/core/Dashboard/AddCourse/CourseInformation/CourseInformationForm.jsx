        ...
        >
            ...
            <div className="flex flex-col space-y-2">
                ...
                <textarea
                    ...
                    className="form-style resize-x-none min-h-[130px] w-full p-2 rounded-lg"
                />
            ...
            <div className="relative flex flex-col space-y-2">
                ...
                <input
                    ...
                    className="form-style w-full !pl-12 p-2 rounded-lg"
                />
                <HiOutlineCurrencyRupee
                    size={30}
                    className="absolute top-6 text-richblack-400"
                />
                {errors.coursePrice && (
                    <span className="ml-2 text-xs tracking-wide text-pink-200">
