        ...
        <div >
            ...
            <div className='flex flex-row  gap-15 items-center'>
                ...
                <div className='relative  shadow-blue-200'>
                    ...
                    <img src={timelineImage} alt="timelineImage" className=' custom-shadow object-cover h-fit' />
                    ...
                    <div className='absolute bg-caribbeangreen-700 flex flex-row text-white uppercase py-8 
                        ...
                        <div className='flex flex-row  gap-5 items-center border-r border-caribbeangreen-300 px-8'>
                            ...
                            <p className='text-caribbeangreen-5-300 text-sm'>Years of Experience</p>
                        </div>

                        <div className='flex gap-5 items-center px-7'>
                            <p className='text-3xl font-bold'>250</p>
                            <p className='text-caribbeangreen-5-300 text-sm'>Type of Courses</p>
                        </div>
